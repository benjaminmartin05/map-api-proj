...
var Course = function(data) {
    ...
    // Extend markerBounds with each random point. It's only logging one marker right now because map.fitBounds is inside a loop. Placing it outside the loop receives a 'not defined' message.
    // var markerBounds = new google.maps.LatLngBounds();
    // markerBounds.extend(this.marker.position);
    // markerArray.push(markerBounds);
    ...
    this.marker.addListener('click', function() {
        ...
        infoWindow.setContent(self.information);
        infoWindow.open(map, this);
        //panTo centers the map around the marker being selected
